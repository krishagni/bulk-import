...
import com.krishagni.commons.io.CsvReader;
...
public class ObjectReader implements Closeable {
	...
	public ObjectReader(String filePath, ObjectSchema schema, String dateFmt, String timeFmt, char separator) {
		try {
			this.csvReader = CsvFileReader.createCsvFileReader(filePath, true, separator);
			this.schema = schema;
	...
	public static String getSchemaFields(ObjectSchema schema) {
		...
		return Util.stringListToCsv(columnNames);
	}
